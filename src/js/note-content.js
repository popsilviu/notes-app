document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggleButton = document.getElementById('layoutToggleButton');
    ...
    function openEditor(editMode = false, noteIndex = null) {
        ...
        // Hide the Add Card Button when editing or adding a new note
    ...
    function resetEditor() {
        ...
        // Show the Add Card Button after saving the note
    ...
    function displayNotes() {
        ...
        [...notes].reverse().forEach((note, index) => {
            ...
            noteElement.innerHTML = `
                <i class="iconoir-check-circle-solid note__icon" alt="select note"></i>
            ...
            deleteButton.onclick = (event) => {
                event.stopPropagation(); // Prevent event from reaching noteElement
                handleDeleteButtonClick(noteElement.dataset.index);
            };
